...
output "gateway_private_subnets" {
  description = "List of IDs of gateway private subnets"
  value       = aws_subnet.gateway_private.*.id
}
...
output "backend_private_subnets" {
  description = "List of IDs of backend private subnets"
...
output "managed_private_subnets" {
  description = "List of IDs of managed private subnets"
  value       = aws_subnet.managed_private.*.id
}

output "bigdata_private_subnets" {
  description = "List of IDs of bigdata private subnets"
  value       = aws_subnet.bigdata_private.*.id
}
...
output "gateway_private_subnet_arns" {
  description = "List of ARNs of gateway private subnets"
  value       = aws_subnet.gateway_private.*.arn
}

output "frontend_private_subnet_arns" {
  description = "List of ARNs of frontend private subnets"
  value       = aws_subnet.frontend_private.*.arn
}

output "backend_private_subnet_arns" {
  description = "List of ARNs of backend private subnets"
  value       = aws_subnet.backend_private.*.arn
}

output "db_private_subnet_arns" {
  description = "List of ARNs of db private subnets"
  value       = aws_subnet.db_private.*.arn
}
output "managed_private_subnet_arns" {
  description = "List of ARNs of managed private subnets"
  value       = aws_subnet.managed_private.*.arn
}
output "bigdata_private_subnet_arns" {
  description = "List of ARNs of bigdata private subnets"
  value       = aws_subnet.bigdata_private.*.arn
}
