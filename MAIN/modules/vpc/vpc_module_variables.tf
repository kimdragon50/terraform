...
variable "private_subnet_suffix" {
  description = "Suffix to append to private subnets name"
  type        = list(string)
  default     = ["GATEWAY-PRIVATE","GATEWAY-PRIVATE","FRONTEND-PRIVATE","FRONTEND-PRIVATE","BACKEND-PRIVATE","BACKEND-PRIVATE","DB-PRIVATE","DB-PRIVATE","MANAGED-PRIVATE","MANAGED-PRIVATE","BIGDATA-PRIVATE","BIGDATA-PRIVATE"]
}
