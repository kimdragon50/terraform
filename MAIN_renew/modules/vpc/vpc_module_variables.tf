...
variable "private_route_suffix" {
  ...
  type        = list(string)
  default     = ["GATEWAY-PRIVATE-ROUTE-A","GATEWAY-PRIVATE-ROUTE-C","FRONTEND-PRIVATE-ROUTE-A","FRONTEND-PRIVATE-ROUTE-C", 
  "BACKEND-PRIVATE-ROUTE-A","BACKEND-PRIVATE-ROUTE-C","DB-PRIVATE-ROUTE-A","DB-PRIVATE-ROUTE-C", 
  "MANAGED-PRIVATE-ROUTE-A","MANAGED-PRIVATE-ROUTE-C","BIGDATA-PRIVATE-ROUTE-A","BIGDATA-PRIVATE-ROUTE-C"] 
}
...
variable "private_subnet_suffix" {
  description = "Suffix to append to private subnets name"
  type        = list(string)
  default     = ["GATEWAY-PRIVATE-A","GATEWAY-PRIVATE-C","FRONTEND-PRIVATE-A","FRONTEND-PRIVATE-C","BACKEND-PRIVATE-A","BACKEND-PRIVATE-C","DB-PRIVATE-A","DB-PRIVATE-C","MANAGED-PRIVATE-A","MANAGED-PRIVATE-C","BIGDATA-PRIVATE-A","BIGDATA-PRIVATE-C"]
}
...
variable "private_subnets_name" {
  description = "A list of private subnets name inside the VPC"
  type        = list(string)
  default     = []
}
